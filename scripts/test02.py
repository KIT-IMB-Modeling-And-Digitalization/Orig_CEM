...
# === Prepare full paths relative to src ===
img1 = os.path.relpath(os.path.join(results_dir, "cement140w04flocf.img"), src_path)
img2 = os.path.relpath(os.path.join(results_dir, "pcem140w04floc.img"), src_path)
