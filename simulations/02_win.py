...
dst = os.path.join(parent_dir, f"script_{id}")
...
print(f"[DEBUG] Binary path: {bin_path}")
#src_path = os.path.join(base_dir, "..", "scripts")              # scripts/
genpartnew_path = os.path.join(bin_path, "Release", "genpartnew.exe")  
distrib3d_path = os.path.join(bin_path, "Release", "distrib3d.exe")
